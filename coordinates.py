...
class ObjectMoveX(bpy.types.Operator):
    ...
    #handL.tail=(17.36,0,52.48)
        ...
        upper_armL.tail.x -= converter[6][0]/1000
        upper_armL.tail.y += converter[6][0]/1000
        
        print(converter[6][0]/100,converter[6][1]/100)
        ...
        handL.tail.x -= converter[7][0]/100 #0.25
        handL.tail.z -= converter[7][1]/100/2  #0.25  0.54/2
        handL.head.x -= converter[7][0]/100
        handL.head.z -= converter[7][1]/100/2 - 0.1 #0.15
        ...
        shinL.tail.x += converter[13][0]/100+0.04 #12
        shinL.head.x += converter[12][0]/100  #0.13
        shinL.head.y += 0.1
        shinL.tail.y += converter[12][0]/100 #0.12
        
        print(converter[13][0]/100,converter[13][1]/100)  # [12] -  0.13 , 0.26; [13] - 0.13,0.07
         #footL.head = (shinLX,0,shinLZ)
        #footL.tail = (shinLX_tail,0,shinLZ_tail)
        #footL.tail = (shinLX_tail,0,shinLZ_tail)
        toeL = arm.edit_bones['toe.L']
        toeL.tail.x += converter[13][0]/100 + 0.1
        toeL.head.x += converter[13][0]/100 + 0.1
        
        heelL = arm.edit_bones['heel.02.L']
        heelL.tail.x += converter[13][0]/100 + 0.1
        heelL.head.x += converter[13][0]/100 + 0.1
